...
def test_id_translation(steemd_jussi_requests_and_dicts):
    ...
    translated_request_dict = JussiJSONRPCRequest.translate_to_appbase(jsonrpc_request, urn)
    assert translated_request_dict['id'] == jussi_request.id


def test_jsonrpc_translation(steemd_jussi_requests_and_dicts):
    jussi_request, jsonrpc_request = steemd_jussi_requests_and_dicts
    urn = jussi_request.urn
    translated_request_dict = JussiJSONRPCRequest.translate_to_appbase(jsonrpc_request, urn)
...
def test_jrpc_method_translation(steemd_jussi_requests_and_dicts):
    jussi_request, jsonrpc_request = steemd_jussi_requests_and_dicts
    urn = jussi_request.urn
    translated_request_dict = JussiJSONRPCRequest.translate_to_appbase(jsonrpc_request, urn)
...
def test_params_api_translation(steemd_jussi_requests_and_dicts):
    jussi_request, jsonrpc_request = steemd_jussi_requests_and_dicts
    urn = jussi_request.urn
    translated_request_dict = JussiJSONRPCRequest.translate_to_appbase(jsonrpc_request, urn)
